...
*/
public class CuckooHashTableQ3<AnyType>
{
 /**
  * Construct the hash table.
  * @param hf the hash family
  */
 public CuckooHashTableQ3( HashFamily<? super AnyType> hf )
 {
  ...
  */
 public CuckooHashTableQ3( HashFamily<? super AnyType> hf, int size )
 {
 ...
 private static CuckooHashTableQ3<String> a = new CuckooHashTableQ3<String>(new StringHashFamily( 3 ), 2000);
...
//Q2:finds n random strings in the hash table. The method should delete the string if found. It should also compute the average time of each search.
 ...
 public static void main( String [ ] args )
 {
  ...
  //   final int NUMS = 2000;
     ...
     CuckooHashTableQ3<String> H = new CuckooHashTableQ3<>( new StringHashFamily( 3 ), 2000);  
     RandomStringGenerator rng = new RandomStringGenerator();
