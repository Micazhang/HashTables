...
public class CuckooHashTable<AnyType>
{
 ...
 private static CuckooHashTable<String> a = new CuckooHashTable<String>(new StringHashFamily( 3 ), 2000);
 ...
 public static long insert_time(int NUMS) //NUMS is the total number of inserted string
 {
     ...
     System.out.println( "Insert Time used: " + ( (end - start )/NUMS) );
...
//Q2:finds n random strings in the hash table. The method should delete the string if found. It should also compute the average time of each search.
 public static long remove_time(int NUMS)
 {
     ...
     System.out.println( "Remove Time used: " + ( (end - start )/NUMS) );
     return ((end-start)/NUMS);
 }
...
//     }
//     end = System.nanoTime();
//     System.out.println( "Time used: " + ( (end - start )/NUMS) );
